...
const start = async () => { // 非同期処理を行う関数を定義
    try {
        await connectDB("mongodb+srv://s-kimura:t2260622t@cluster0.17g8u.mongodb.net/TODO_App?retryWrites=true&w=majority&appName=Cluster0"); // Connect to the database
